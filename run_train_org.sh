...
CUDA_VISIBLE_DEVICES=0 python metrics_custom.py -m output/$CONFIG -t val
...
CUDA_VISIBLE_DEVICES=1 python metrics_custom.py -m output/$CONFIG -t val
...
CUDA_VISIBLE_DEVICES=2 python metrics_custom.py -m output/$CONFIG -t val
