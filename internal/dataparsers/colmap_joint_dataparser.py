...
class ColmapJointDataParser(ColmapDataParser):
    ...
    def get_outputs(self) -> DataParserOutputs:
        ...
        for idx, key in enumerate(images):
            ...
            camera_type_list.append(intrinsics.id - 1)
        ...
        # print information
        print("[colmap_joint dataparser] train set images: {}, val set images: {}, loaded mask: {}".format(
            len(image_set[0]),
            len(image_set[1]),
            loaded_mask_count,
        ))
