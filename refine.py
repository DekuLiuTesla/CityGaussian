...
import sys
from scene import Scene, RefinedScene
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    scene = RefinedScene(dataset, gaussians)
...
def training_report(tb_writer, iteration, Ll1, loss, l1_loss, t_render, t_loss, t_densify, elapsed, testing_iterations, scene : Scene, renderFunc, renderArgs):
    if tb_writer:
