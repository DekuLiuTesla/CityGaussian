...
python tools/transform_json2txt_mc.py --source_path data/matrix_city/aerial_street_fusion/street/train
python tools/convert_cam.py -s data/matrix_city/aerial_street_fusion/street/train

python tools/transform_json2txt_mc.py --source_path data/matrix_city/aerial_street_fusion/street/test
