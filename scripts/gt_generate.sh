...
python tools/generate_traj.py --config outputs/citygs2d_lfls_coarse_lnorm4_wo_vast_sep_depth_init_5/config.yaml --train --ellipse --scale_percentile 75 --n_fames 480
python tools/generate_traj.py --config outputs/citygs2d_smbu_coarse_lnorm4_wo_vast_sep_depth_init_5/config.yaml --train --ellipse --scale_percentile 75 --n_fames 480
python tools/generate_traj.py --config outputs/citygs2d_upper_coarse_lnorm4_wo_vast_sep_depth_init_5/config.yaml --train --ellipse --scale_percentile 75 --n_fames 480
python tools/generate_traj.py --config outputs/citygs2d_mc_aerial_coarse_lnorm4_wo_vast_sep_depth_init_5/config.yaml --data_path data/matrix_city/aerial/train/block_all --scale_percentile 75 --ellipse
# python tools/generate_traj.py --config outputs/citygs2d_mc_street_coarse_lnorm4_wo_vast_sep_depth_init_5_ubd1e1/config.yaml --data_path data/matrix_city/street/train/block_A --ellipse