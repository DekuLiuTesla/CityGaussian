...
COARSE_NAME=citygs2d_residence_coarse
NAME=citygs2d_residence
...
#                               --mesh_path "outputs/$NAME/mesh/merged_epoch=12-step=30000" \
#                               --scale_percentile 90 \
#                               --pitch 30
...
CUDA_VISIBLE_DEVICES=1 python render_sun.py \
                     --load_dir "../outputs/$NAME/mesh/merged_epoch=12-step=30000" \
