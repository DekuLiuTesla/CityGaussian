...
COARSE_NAME=citygs2d_building_coarse
NAME=citygs2d_building
...
#                               --mesh_path "outputs/$NAME/mesh/merged_epoch=16-step=30000" \
#                               --scale_percentile 90 \
#                               --pitch 30
...
gpu_id=$(get_available_gpu)
echo "GPU $gpu_id is available."
CUDA_VISIBLE_DEVICES=4 python render_sun.py \
                     --load_dir "../outputs/$NAME/mesh/merged_epoch=16-step=30000" \
