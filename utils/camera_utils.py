...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    if args.resolution in [1, 2, 4, 8, 16, 32, 64, 128]:
...
def loadCamTA1(args, id, cam_info, resolution_scale, pitch=None, height=None):
    # use appointed pitch and height
    orig_w, orig_h = cam_info.image.size
...
def loadCamTA3(args, id, cam_info, resolution_scale, xyz=None, pitch=None, yaw=None):
    # use appointed pitch and height
    orig_w, orig_h = cam_info.image.size
    ...
    if yaw is not None and pitch is not None and xyz is not None:
        Rt = np.zeros((4, 4))
        Rt[:3, :3] = cam_info.R.transpose()
        Rt[:3, 3] = cam_info.T
        Rt[3, 3] = 1.0
